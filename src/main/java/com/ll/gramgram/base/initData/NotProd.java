    ...
    CommandLineRunner initData(
        ...
        return new CommandLineRunner() {
            ...
            public void run(String... args) throws Exception {
                ...
                Member memberUser6ByKakao = memberService.whenSocialLogin("KAKAO", "KAKAO__2733190880").getData();
                Member memberUser7ByGoogle = memberService.whenSocialLogin("GOOGLE", "GOOGLE__106827022595451603366").getData();
                Member memberUser8ByNaver = memberService.whenSocialLogin("NAVER", "NAVER__OWZ0Fljj2qiN7bV7ay9lsqi86kRYuTLVcV1UBOs08Xs").getData();
                Member memberUser9ByFacebook = memberService.whenSocialLogin("FACEBOOK", "FACEBOOK__104673682622674").getData();
